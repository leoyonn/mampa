 ...
 * @author leo
 */
public interface IActorGroup<K1, K2> {
    /**
     ...
     * @return
     */
    boolean tell(K1 actorTarget, IFsmType fsmType, K2 fsmTarget, IEventType etype, Object edata);
     ...
     * @return
     */
    boolean tellSync(K1 actorTarget, IFsmType fsmType, K2 fsmTarget, IEventType etype, Object edata);
     ...
     * @return
     */
    boolean batchTell(List<K1> actorTargets, IFsmType fsmType, List<K2> fsmTargets, IEventType etype, Object edata);
